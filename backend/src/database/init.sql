-- Create database if not exists (for manual execution)
...
-- Test data
INSERT INTO books (title, author, description, genre, publication_date) VALUES
('1984', 'George Orwell', 'Dystopian novel', 'Fiction', '1949-06-08'),
('To Kill a Mockingbird', 'Harper Lee', 'Classic novel', 'Fiction', '1960-07-11'),
('The Great Gatsby', 'F. Scott Fitzgerald', 'American classic', 'Fiction', '1925-04-10')
